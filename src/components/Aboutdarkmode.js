...
function Aboutdarkmode(props) {
    return (
        ...
        <div className='container' style={{backgroundColor:props.mode === 'light'?'white':'grey'}}>
            <h1>About Us</h1>
            <div className="accordion mx-3 my-3" id="accordionExample" style={{backgroundColor:props.mode === 'light'?'white':'grey'}}>
        ...
        btnText
        <button type="button" onClick={toggleStyle} className="btn btn-dark"></button>
        </div>  */}
